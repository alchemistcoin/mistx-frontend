import { ChainId, Currency, CurrencyAmount, TokenAmount, Price, Token, Exchange } from '@alchemistcoin/sdk'
...
const usdcCurrencyAmount = new TokenAmount(USDC, String(100_000e6))
